...
public class ConstantVideoclip implements Videoclip {
    ...
    public ConstantVideoclip(String uuid, String title, String description, Image thumbnail, 
            Instant recordingDateTime, List<String> participants, List<String> tags) {
        this.uuid = uuid;
        this.title = title;
